...
GGML_METAL_PATH_RESOURCES=~/bin/whisper-cpp-lib/ ~/bin/whisper-cpp -m ~/bin/whisper-cpp-lib/ggml-large-v3-q5_0.bin -l ja --output-vtt -f /tmp/WHISPER_CPP_JP_TMP.wav
